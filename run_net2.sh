#!/bin/bash -l
#MSUB -o /work/ws/nemo/fr_ds567-lth_ws-0/nemo_logs/run_net2.out # STDOUT  (the folder log has to be created prior to running or this won't work)
...
python3 -m src.vanilla_pytorch.run_pruning_experiment --model Net2 --batch-size 60 --epochs 30 --lr 2e-4 --pruning-levels 10 --dataset cifar10 --name Net2Run
